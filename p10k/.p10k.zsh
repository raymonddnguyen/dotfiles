# Generated by Powerlevel10k configuration wizard on 2020-04-27 at 00:51 PDT.
...
# unicode, 12h time, angled separators, sharp heads, flat tails, 1 line, compact,
...
() {
  ...
  # typeset -g POWERLEVEL9K_RANGER_BACKGROUND=3
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_VIM_SHELL_BACKGROUND=4
  # Custom icon.
